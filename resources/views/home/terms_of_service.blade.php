...
（5）その他，当社が利用登録を相当でないと判断した場合
    ...
    <h2 class="mt-5">第3条（ユーザーIDおよびパスワードの管理）</h2>
    ...
    <h2 class="mt-5">第4条（利用料金および支払方法）</h2>
...
（12）その他，当社が不適切と判断する行為
    ...
    <h2 class="mt-5">第6条（本サービスの提供の停止等）</h2>
...
当社は，本サービスの提供の停止または中断により，ユーザーまたは第三者が被ったいかなる不利益または損害について，理由を問わず一切の責任を負わないものとします。
    ...
    <h2 class="mt-5">第7条（著作権）</h2>
    <p>ユーザーは，自ら著作権等の必要な知的財産権を有するか，または必要な権利者の許諾を得た文章，画像や映像等の情報のみ，本サービスを利用し，投稿または編集することができるものとします。
...
前項本文の定めるものを除き，本サービスおよび本サービスに関連する一切の情報についての著作権およびその他知的財産権はすべて当社または当社にその利用を許諾した権利者に帰属し，ユーザーは無断で複製，譲渡，貸与，翻訳，改変，転載，公衆送信（送信可能化を含みます。），伝送，配布，出版，営業使用等をしてはならないものとします。</p>
    ...
    <h2 class="mt-5">第8条（利用制限および登録抹消）</h2>
...
当社は，本条に基づき当社が行った行為によりユーザーに生じた損害について，一切の責任を負いません。
    ...
    <h2 class="mt-5">第9条（保証の否認および免責事項）</h2>
