...
<div class="container pt-4">
    <h1>利用規約</h1>
    <p>この利用規約（以下，「本規約」といいます。）は，WaZ（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>

    <h2 class="mt-5">第1条（適用）</h2>
    <p>本規約は，ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。</p>

    <h2 class="mt-5">第2条（利用登録）</h2>
    <ol>
    ...
    <h2 class="mt-5">第4条（個人情報の取り扱い）</h2>
    <p>個人情報及び利用者情報については、当社が別途定める「<a href="{{ route('home.privacy') }}">プライバシーポリシー</a>」に則り、適正に取り扱うこととします。</p>

    <h2 class="mt-5">第5条（広告の掲載について）</h2>
    <p>利用者は、本サービス上にあらゆる広告が含まれる場合があること、当社またはその提携先があらゆる広告を掲載する場合があることを理解しこれを承諾したものとみなします。本サービス上の広告の形態や範囲は、当社によって随時変更されます。</p>

    <h2 class="mt-5">第6条（利用料金および支払方法）</h2>
    <ol>
    ...
    <h2 class="mt-5">第8条（本サービスの提供の停止等）</h2>
    <ol>
    ...
    <h2 class="mt-5">第10条（利用制限および登録抹消）</h2>
    <ol>
    ...
    <h2 class="mt-5">第11条（保証の否認および免責事項）</h2>
    <ol>
    ...
    <h2 class="mt-5">第12条（サービス内容の変更等）</h2>
    <p>当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。</p>

    <h2 class="mt-5">第13条（利用規約の変更）</h2>
    <p>当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。</p>

    <h2 class="mt-5">第14条（通知または連絡）</h2>
    <p>本サービスに関する利用者の当社へのご連絡・お問い合わせは、本サービスまたは当社が運営するwebサイト内の適宜の場所に設置するお問い合わせフォームからの送信、または当社が別途指定する方法により行うものとします。</p>

    <h2 class="mt-5">第15条（権利義務の譲渡の禁止）</h2>
    <p>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>

    <h2 class="mt-5">第16条（準拠法・裁判管轄）</h2>
    <ol>
